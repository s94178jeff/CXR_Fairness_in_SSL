...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, num_channel=3):
        ...
        self.in_planes = 16
        self.conv1 = nn.Conv2d(
            num_channel, 16, kernel_size=3, stride=1, padding=1, bias=False
        )
...
def resnet20(num_classes,num_channel = 3):
    return ResNet(BasicBlock, [3, 3, 3], num_classes,num_channel)
